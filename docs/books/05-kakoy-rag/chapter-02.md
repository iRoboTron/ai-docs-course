...
На примере: один и тот же кусок «Гарантия» оказался на 2-м месте у поиска по словам и на 1-м — у поиска по смыслу. Его RRF-счёт: 1/2 + 1/1 = 0,5 + 1,0 = **1,5**. Кусок «Доставка», который поиск по словам поставил на 1-е место, а поиск по смыслу вообще не нашёл, получает только 1/1 + 0 = **1,0**. В общем списке «Гарантия» окажется выше «Доставки» — она хорошо показала себя в обеих системах, а не только в одной.

Почему не просто сложить сырые оценки (косинусную близость и счёт совпавших слов)? Потому что это разные шкалы: 0,82 по смыслу и 3 совпавших слова — не одна и та же единица измерения, складывать их напрямую бессмысленно. А место в списке — всегда просто число от 1 и выше, его можно складывать у любых двух поисков.
